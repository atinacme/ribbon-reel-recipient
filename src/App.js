    ...
    <div className="client--side-section--wrapper">
      <div className="container animation_all_steps page-width">
        ...
        <div className="animation-step1 step ">
          ...
          <div className="button"><a href="#" className="e1b">Continue to the video message <svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12.01 3H0V5H12.01V8L16 4L12.01 0V3Z" fill="#00187F" />
          </svg></a></div>
          <div className="lowertext mt30 e1sb"><a href="#">What is RibbonReel?</a></div>
        </div>

        <div className="animation-step2 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
        </div>

        <div className="animation-step3 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
          <div className="innerstage"> <div className="lowertext e2b">First</div>
          </div>
        </div>
        <div className="animation-step4 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
        ...
        <div className="animation-step5 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
          <div className="innerstage">
            ...
            <div className="button_text mt90"><a href="#" className="e2b txt20">Yes I have it with me <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="animation-step6 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
          <div className="innerstage">    <div className="lowertext e2b txt29">...</div> </div>
        </div>

        <div className="animation-step7 step hide">
          <div className="title e2b">To Sebastian From Alex</div>
          <div className="innerstage">
            ...
            <div className="button_text mt90" ><a href="#" className="e2b txt20">C'MON! <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.01 3.5H0V5.5H12.01V8.5L16 4.5L12.01 0.5V3.5Z" fill="white" />
            </svg>
            </a></div>
        ...
        <div className="animation-step8 step hide">
          <div className="button"><a href="#" className="round small-btn e1sb center-btn">Open</a></div>
        </div>

        <div className="animation-step9 step hide">
          <div className="video-wrap">
            <video width="320" height="240" controls autoplay muted>
              <source src="https://cdn.shopify.com/videos/c/o/v/122db422ff1f4ab0ba1998ce892344fb.mp4" type="video/mp4" />
            </video>
          </div>
        </div>
      </div>
