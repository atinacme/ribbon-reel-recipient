...
function App() {
  ...
  useEffect(() => {
      ...
      setFirstDesc(
        <>
          ...
          <div className="button_text mt30">
            <a href="#" className="e2b txt20" onClick={() => setFirstSure(true)}>
    ...
    return () => {
      console.log(`clearing intervalDesc`);
  ...
  console.log("length--->", vid, vid?.duration, vid?.ended);

  return (
    <div className="client--side-section--wrapper">
      <div className="container animation_all_steps page-width">
        {!open ?
          <>
            {!videoMsg ?
              <>
                ...
                <div className="animation-step1 step ">
                  ...
                  <div className="button" onClick={() => setVideoMsg(true)}><a href="#" className="e1b">Continue to the video message <svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
